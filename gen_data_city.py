...
HEIGHT = 128
SUB_FOLDER = 'train'
INPUT_DIR = '/databases/cityscapes'
OUTPUT_DIR = '/home/FisicaroF/5/struct2depth/CITYSCAPES_Processed'
  ...
  for location in glob.glob(INPUT_DIR + '/leftImg8bit_sequence/' + SUB_FOLDER + '/*'):
    ...
    for (k,v) in sequences.items():
        ...
        for j in range(0, len(files), SKIP):
            ...
            segimg = cv2.imread((files[j].replace('.jpg', '_instance.png')).replace('sequence', 'instance')) 
