...
flags.DEFINE_string('dataset_dir', None, 'Directory of the data in the ' 
                  'input_list_file if they are not in the same place.')
...
def collect_input_images(input_dir, input_list_file, file_extension, dataset_dir):
